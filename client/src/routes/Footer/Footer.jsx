...
export function Footer() {
  ...
  return (
    <footer className='footer' id="contacts">
      <div className='divg'>
        <div className='dsa'>
          <img src="../../public/logo.svg" alt="BaseMotors" />
        ...
        <div>
          ...
          <div className='social-icons'>
            <img className='img-social1' src="../../public/Youtube_logo.png" alt="" />
            <img className='img-social2' src="../../public/VK.com-logo.svg" alt="" />
            <img className='img-social3' src="../../public/Telegram_2019_Logo.svg.png" alt="" />
          </div>
        </div>
        <div>
          <h3>Принимаем к оплате</h3>
          <div className='payment-icons'>
            <img className='img-social4' src="../../public/Visa_Inc._logo_(2021–present).svg.png" alt="" />
            <img className='img-social5' src="../../public/Mir-logo.SVG.svg.png" alt="" />
            <img className='img-social6' src="../../public/Mastercard-logo.svg.png" alt="" />
          </div>
        </div>
      </div>
      <p className='la'>
